...
class RangeSliderUI extends BasicSliderUI {
    ...
    private java.awt.Polygon polygonLower;
    
    private java.awt.Polygon polygonUpper;
    ...
    public RangeSliderUI(RangeSlider b) {
        super(b);
        int[] xPointsLower = {5, 20, 10, 5, 0, 5}, yPointsLower = {5, 5, 15, 15, 10, 5};
        polygonLower = new Polygon(xPointsLower, yPointsLower, 6);
        int[] xPointsUpper = {5, 10, 20, 5, 0, 5}, yPointsUpper = {-5, -5, 5, 5, 0, -5};
        polygonUpper = new Polygon(xPointsUpper, yPointsUpper, 6);
    }
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(new Color(50, 93, 157));
        g2d.draw(thumbShape);
